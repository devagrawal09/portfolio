...
date: 2023-12-13
source: DEV
originalUrl: https://dev.to/clerk/clerk-webhooks-data-sync-with-convex-1jeh
tags:
  - "react"
  - "auth"
  - "data"
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/9lg3kz1geikkydu9xbxr.png)
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/bjwp0pfmvpf77siyhbeg.png)
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/gxli0i6bjmgaedbtryrl.png)
...
export const getUser = internalQuery({
  ...
  async handler(ctx, args) {
    return ctx.d
      .query("users")
      .withIndex("by_clerk_id", (q) => q.eq("clerkUser.id", args.subject))7
      .unique();
  },
});
```
